...
const VideoDetail = () => {
    ...
    useEffect(() => {
        if (!id) return; // Ensure id is defined before making API call
                    ...
                    <Box sx={{ width: '100%', position: "sticky", top: '86px' }}>
                        ...
                        <Stack direction="row" justifyContent='space-between' sx={{ color: '#fff' }} py={1} px={2}>
                            ...
                            <Stack direction="row" gap="20px" alignItems="center">
                                <Typography variant='body1' sx={{ opacity: 0.5 }}>{parseInt(viewCount).toLocaleString()} views</Typography>
                                <Typography variant='body1' sx={{ opacity: 0.5 }}>{parseInt(likeCount).toLocaleString()} Likes</Typography>
                            </Stack>
                        </Stack>
                    </Box>
                </Box>
